...
class PizzaOrder(models.Model):
    # Linking:
    kind = models.ForeignKey(PizzaMenuItem, related_name='pizzas', on_delete=DO_NOTHING)
    size = models.ForeignKey('PizzaSize', related_name='pizzas', on_delete=DO_NOTHING)
    delivery = models.ForeignKey('Address', related_name='pizzas', on_delete=DO_NOTHING)
